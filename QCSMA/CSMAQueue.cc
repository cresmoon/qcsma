...
void CSMAQueue::handleMessage(cMessage *msg)
{
...
double CSMAQueue::BackoffGeneration()
{
    double bf = (double)(intuniform(1,TimeSize)*0.01);
    return bf;
}

double CSMAQueue::MsgLengGeneration()
{
